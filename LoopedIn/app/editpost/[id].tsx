...
export default function EditPost() {
  ...
  const fetchData = async () => {
    ...
    if (!token) {
      alert(
        "You need to login in & own this post before you can edit it! How did you even get here?"
      );
            ...
            >
              {photoCards.map((card, index) => (
                ...
                >
                  ...
                  <View
                    style={[styles.uploadArea, styles.uploadAreaDisabled]}
                    accessible={true}
                    accessibilityLabel={"Uploaded photo"}
                    accessibilityHint={
                      "Photo updates are disabled. Update alt text below."
                    }
                  ...
                  >
                    ...
                    <View style={styles.disabledContent}>
                      ...
                      <Text style={styles.uploadTitle}>
                        Photo updates disabled
                      </Text>
                      <Text style={styles.uploadSubtitle}>
                        Add or remove photos on the create flow. Update alt text
                        here.
                      </Text>
                    </View>
                  </View>
