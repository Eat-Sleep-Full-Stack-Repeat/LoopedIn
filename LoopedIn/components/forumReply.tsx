          ...
          <View style={styles.postCard}>
            <View style={styles.postHeaderRow}>
              {replyPost.profileuri ? (
                <Image
                  source={{ uri: replyPost.profileuri }}
                ...
                <View style={styles.postUserRow}>
                  ...
                  {replyPost.dateposted ? (
                    <Text style={styles.postDate}>
                      {new Date(replyPost.dateposted).toLocaleDateString(
                        "en-US",
                        {
                          month: "short",
                          day: "numeric",
            ...
            <View style={styles.commentHeaderRow}>
              ...
              <View style={styles.commentHeaderText}>
                ...
                <Text style={styles.commentDate}>
                  {new Date(replyPost.date).toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric",
                    year: "numeric",
                  })}
        ...
        <View style={styles.replyContainer}>
          ...
          >
            <Pressable
              ...
              style={[
                styles.button,
                { borderWidth: 1, borderColor: colors.cancel },
              ]}
              accessible={true}
            ...
            >
              <Text style={{ color: colors.cancel }}> Cancel </Text>
            </Pressable>
            <Pressable
              onPress={handlePost}
              style={[
              ...
              accessibilityRole={"button"}
            >
              <Text style={{ color: colors.antiText }}>Post →</Text>
            </Pressable>
          </View>
        </View>
      </KeyboardAvoidingView>
